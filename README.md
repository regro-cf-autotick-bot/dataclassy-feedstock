...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dataclassy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13923&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dataclassy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dataclassy` can be installed with:

```
conda install dataclassy
```

It is possible to list all of the versions of `dataclassy` available on your platform with:
